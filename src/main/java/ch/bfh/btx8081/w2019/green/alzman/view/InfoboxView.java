...
public class InfoboxView extends TemplateView {
	...
	public InfoboxView() {
		...
		importentNr.add(new Label("Geschlecht"), new Label("Name Vorname"), new Label("Telefonnummer"),
				new Label("Adresse Nr."), new Label("Platz Ort"), new Button("Edit"), new Button("Delete"));
		accordion1.add("Hans Muster", importentNr);

		super.addContent(accordion1);

		VerticalLayout importentNr1 = new VerticalLayout();
		importentNr1.add(new Label("Geschlecht"), new Label("Name Vorname"), new Label("Telefonnummer"),
				new Label("Adresse Nr."), new Label("Platz Ort"), new Button("Edit"), new Button("Delete"));
		...
		importentAdr.add(new Label("Geschlecht"), new Label("Name Vorname"), new Label("Telefonnummer"),
				new Label("Adresse Nr."), new Label("Platz Ort"), new Button("Edit"), new Button("Delete"));
		...
		importentAdr1.add(new Label("Geschlecht"), new Label("Name Vorname"), new Label("Telefonnummer"),
				new Label("Adresse Nr."), new Label("Platz Ort"), new Button("Edit"), new Button("Delete"));
